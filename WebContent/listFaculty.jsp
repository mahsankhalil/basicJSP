...
<div class="form-group">
  ...
  <% 
	...
	while(rs.next()){
		...
		<td><a class="btn btn-success" href="updateFaculty.jsp?id=<%=rs.getInt("id") %>" role="button">Edit</a><a class="btn btn-danger" href="removeFaculty.jsp?id=<%=rs.getInt("id") %>" role="button">Remove</a></td>
		</tr>
	<% }%>	
