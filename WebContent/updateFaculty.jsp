...
<html>
   		...
   		if(request.getMethod().compareToIgnoreCase("post")==0)
   		{
   			try
   			{
   				...
   				String name = request.getParameter("name");
   	   			...
   	   			String query = "UPDATE `faculty` SET `name`=?,`address`=? ,`state`=? ,`postal_code`=? WHERE id = ?";
    ...
    <div class="form-group col-12 p-0">
        ...
        <form id="form" method="post" action="updateFaculty.jsp" class="form-horizontal">
         	
            <div class="form-group">
                <div  class="col-sm-4"></div>
                <div  class="col-sm-4">
                    <h2 style="text-align: center">Update Following Details</h2>
                </div>
            </div>
            <hr/>
