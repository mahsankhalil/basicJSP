...
<html>
   		...
   		if(request.getMethod().compareToIgnoreCase("post")==0)
   		{
   			try
   			{
   				String name = request.getParameter("name");
   	   			...
   	   			String query = "INSERT INTO `faculty`(`name`, `address`, `postal_code`, `state`) VALUES (?,?,?,?)";
    ...
    <div class="form-group col-12 p-0">
        ...
        <form id="form" method="post" action="insertFaculty.jsp" class="form-horizontal">
